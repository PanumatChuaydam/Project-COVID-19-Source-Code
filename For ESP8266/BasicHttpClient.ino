...
void loop() {
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
    ...
    if (http.begin(client, "http://10.232.150.39:8080/project/DB/get/test/GetData.php?ID=9")) {  // HTTP
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
      ...
      Serial.print("[HTTP] begin...\n");
      if (http2.begin(client2, "http://10.232.150.39:8080/project/DB/get/test/GetData.php?ID=10")) {  // HTTP
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
      ...
      Serial.print("[HTTP] begin...\n");
      if (http3.begin(client3, "http://10.232.150.39:8080/project/DB/get/test/GetData.php?ID=11")) {  // HTTP
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
      ...
      Serial.print("[HTTP] begin...\n");
      if (http4.begin(client4, "http://10.232.150.39:8080/project/DB/get/test/GetData.php?ID=12")) {  // HTTP
    ...
    if ((WiFiMulti.run() == WL_CONNECTED)) {
      ...
      Serial.print("[HTTP] begin...\n");
      if (http5.begin(client5, "http://10.232.150.39:8080/project/DB/get/test/GetDatas.php?ID=1")) {  // HTTP
        Serial.print("[HTTP] GET...\n");
        // start connection and send HTTP header
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
      ...
      Serial.print("[HTTP] begin...\n");
      if (http6.begin(client6, "http://10.232.150.39:8080/project/DB/get/test/GetDatas.php?ID=2")) {  // HTTP
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
      ...
      Serial.print("[HTTP] begin...\n");
      if (http7.begin(client7, "http://10.232.150.39:8080/project/DB/get/test/GetDatas.php?ID=3")) {  // HTTP
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
      ...
      Serial.print("[HTTP] begin...\n");
      if (http8.begin(client8, "http://10.232.150.39:8080/project/DB/get/test/GetDatas.php?ID=4")) {  // HTTP
  ...
  Serial.println(distanceCm);
    ...
    if(distanceCm >= 1000){
      ...
      if( id1 =="success" ){
        ...
        postData = "&Patient_ID=" + String(Patient_ID) + "&spo2=" + spo2 + "&pulse=" + pulse + "&temp=" + temp;
        WiFiClient client9;
        HTTPClient httpin;
        httpin.begin(client9,"http://10.232.150.39:8080/Project/insert_board_esp8266/InsertDB.php");    
        ...
        http101.begin(client101, "http://10.232.150.39:8080/Project/update/health_box_symptoms.php");
        ...
        WiFiClient client10;
        HTTPClient httpin;
        httpin.begin(client10,"http://10.232.150.39:8080/Project/insert_board_esp8266/InsertDB.php");    
        httpin.addHeader("Content-Type", "application/x-www-form-urlencoded");          
        int httpCodein = httpin.POST(postData);   
        String payload = httpin.getString();    
        httpin.end();  //Close connection
        ...
        http102.begin(client102, "http://10.232.150.39:8080/Project/update/health_box_symptoms.php");
        ...
        WiFiClient client11;
        HTTPClient httpin;
        httpin.begin(client11,"http://10.232.150.39:8080/Project/insert_board_esp8266/InsertDB.php");    
        httpin.addHeader("Content-Type", "application/x-www-form-urlencoded");          
        int httpCodein = httpin.POST(postData);   
        String payload = httpin.getString();    
        httpin.end();  //Close connection
        ...
        http103.begin(client103, "http://10.232.150.39:8080/Project/update/health_box_symptoms.php");
        ...
        WiFiClient client12;
        HTTPClient httpin;
        httpin.begin(client12, "http://10.232.150.39:8080/Project/insert_board_esp8266/InsertDB.php");
        httpin.addHeader("Content-Type", "application/x-www-form-urlencoded");
        int httpCodein = httpin.POST(postData);
        String payload = httpin.getString();
        httpin.end();
        ...
        http104.begin(client104, "http://10.232.150.39:8080/Project/update/health_box_symptoms.php");
